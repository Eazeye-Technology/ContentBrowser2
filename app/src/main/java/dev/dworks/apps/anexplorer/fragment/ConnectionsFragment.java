...
public class ConnectionsFragment extends RecyclerFragment
    ...
    public void menuItemAction(MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.cloud_gridve) {
            addCloudConnection(TYPE_GDRIVE);
        } else if (menuItem.getItemId() == R.id.cloud_dropbox) {
            addCloudConnection(TYPE_DROPBOX);
        } else if (menuItem.getItemId() == R.id.cloud_onedrive) {
            addCloudConnection(TYPE_ONEDRIVE);
        } else if (menuItem.getItemId() == R.id.cloud_box) {
            addCloudConnection(TYPE_BOX);
        } else if (menuItem.getItemId() == R.id.network_ftp) {
            addConnection();
