...
public class AboutActivity extends AboutFlavour implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(view instanceof Toolbar){
			...
			mToolbar.setTitleTextAppearance(this, androidx.appcompat.R.style.TextAppearance_AppCompat_Widget_ActionBar_Title); //R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
			if(Utils.hasKitKat() && !Utils.hasLollipop()) {
	...
	public void onClick(View view) {
		if (view.getId() == R.id.action_feedback) {
            openFeedback(this);
        } else if (view.getId() == R.id.action_rate) {
            openPlaystore(this);
            AnalyticsManager.logEvent("app_rate");
        } else if (view.getId() == R.id.action_sponsor) {
            showAd();
            AnalyticsManager.logEvent("app_sponsor");
        } else if (view.getId() == R.id.action_support) {
