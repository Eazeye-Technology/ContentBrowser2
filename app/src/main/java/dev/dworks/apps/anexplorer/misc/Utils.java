...
public class Utils extends UtilsFlavour{
    ...
    public static boolean isProVersion(){
        return true;//BuildConfig.FLAVOR.contains("Pro") || BuildConfig.FLAVOR.contains("Underground");
    }

    public static boolean isOtherBuild(){
        return false/*BuildConfig.FLAVOR.contains("other")*/;
    }

    public static boolean isGoogleBuild(){
        return false/*BuildConfig.FLAVOR.contains("google")*/;
    }

    public static boolean isAmazonBuild(){
        return false/*BuildConfig.FLAVOR.contains("amazon")*/;
    }
