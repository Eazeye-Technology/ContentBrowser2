...
public class LibraryGridAdapter3 extends BaseAdapter {
    ...
    public LibraryGridAdapter3(Context context, List<FileMeta> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(this.context, R.layout.pagegridviewitem_library3, null);
