...
public class MimeTypesUtil {
	...
	//see github.com/morristech/android-commons/blob/6568a57f6790b1e787c84596596090721aef4714/utils/src/org/mcxiaoke/commons/util/MimeUtils.java
	static {
	...
	public static void add(String type, String extension) {
	...
	private static HashMap<String, String> wpsMimeMap = new HashMap<String, String>(50, 1);
	
	static {
		wpsMimeMap.put(".ppt", "application/vnd.ms-powerpoint");
		wpsMimeMap.put(".pptx", "application/vnd.ms-powerpoint");
	
		wpsMimeMap.put(".doc", "application/msword");
		wpsMimeMap.put(".docx", "application/msword");
	
		wpsMimeMap.put(".xls", "application/vnd.ms-excel");
		wpsMimeMap.put(".xlsx", "application/vnd.ms-excel");
	
		//wpsMimeMap.put(".pdf", "application/pdf");
		
		wpsMimeMap.put(".txt", "text/plain");
	}
