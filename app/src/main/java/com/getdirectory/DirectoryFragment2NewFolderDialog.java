...
public class DirectoryFragment2NewFolderDialog {
    ...
    public DirectoryFragment2NewFolderDialog(Activity ctx, Runnable runnable) {
        this.mContext = ctx;
    ...
    public AlertDialog create() {
        AlertDialog dialog = new MaterialAlertDialogBuilder(this.mContext, getCenteredTitleThemeOverlay())
                //.setTitle(title)
                .setView(R.layout.activity_directory_fragment2_newfolder)
                //.setCancelable(true)
                .setCancelable(false)
            ...
            public void onShow(DialogInterface dialogInterface) {
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        TextInputEditText textState = (TextInputEditText) dialog.findViewById(R.id.textState);
                        m_Input = textState.getText().toString();
                        if (mRunnable != null) {
                            mRunnable.run();
                        }
                    }
