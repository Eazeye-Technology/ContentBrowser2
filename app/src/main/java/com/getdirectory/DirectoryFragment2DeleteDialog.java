...
public class DirectoryFragment2DeleteDialog {
    ...
    public DirectoryFragment2DeleteDialog(Activity ctx, Runnable runnable) {
        this.mContext = ctx;
    ...
    public AlertDialog create() {
        AlertDialog dialog = new MaterialAlertDialogBuilder(this.mContext, getCenteredTitleThemeOverlay())
                //.setTitle(title)
                .setView(R.layout.activity_directory_fragment2_delete)
                //.setCancelable(true)
                .setCancelable(false)
