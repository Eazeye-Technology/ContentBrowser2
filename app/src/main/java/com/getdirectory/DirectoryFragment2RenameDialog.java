...
public class DirectoryFragment2RenameDialog {
    ...
    public DirectoryFragment2RenameDialog(Activity ctx, Runnable runnable) {
        this.mContext = ctx;
    ...
    public AlertDialog create() {
        AlertDialog dialog = new MaterialAlertDialogBuilder(this.mContext, getCenteredTitleThemeOverlay())
                //.setTitle(title)
                .setView(R.layout.activity_directory_fragment2_rename)
                //.setCancelable(true)
                .setCancelable(false)
