...
public class ImageExtractor {
    ...
    public Bitmap proccessCoverPage(PageUrl pageUrl) {
        ...
        } else if (ExtUtils.isLibreFile(unZipPath) || (unZipPath != null && unZipPath.endsWith(".docx"))) {
    ...
    public InputStream getStreamInner(final String imageUri, String hash) throws IOException {
        ...
        try {
            ...
            //FIXME:base64
            if (path != null && path.startsWith(BaseExtractor.BASE64_PREFIX)) {
                FileMeta fileMeta = AppDB.get().getOrCreate(path);
                ...
                return BaseExtractor.decodeImageByBase64(path, IMG.getImageSize());
            }
