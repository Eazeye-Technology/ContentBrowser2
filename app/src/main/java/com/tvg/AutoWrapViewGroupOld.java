 ...
 *
 */
public class AutoWrapViewGroupOld extends ViewGroup {
	...
	public AutoWrapViewGroupOld(Context context) {
		super(context);
	}

	public AutoWrapViewGroupOld(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
